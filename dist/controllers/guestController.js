...
const addGuest = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { firstName, lastName, email, phone, qrCodeColor, eventId } = req.body;
...
const downloadQRCode = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // ✅ Upload QR code to Cloudinary
        const uploadResponse = yield uploadImage_1.cloudinary.uploader.upload_stream({ resource_type: "image", folder: "qrcodes" }, (error, result) => __awaiter(void 0, void 0, void 0, function* () {
            if (error) {
