...
router.get("/:eventId/analytics/overview", auth_1.default, analyticsController_1.getAnalyticsOverview);
router.get("/:eventId/analytics/channels", auth_1.default, analyticsController_1.getChannelAnalytics);
router.get("/:eventId/analytics/timeline", auth_1.default, analyticsController_1.getTimelineAnalytics);
router.get("/:eventId/analytics/export", auth_1.default, analyticsController_1.getAnalyticsExport);
router.get("/:eventId/analytics/email", auth_1.default, analyticsController_1.getEmailAnalytics);
router.get("/:eventId/analytics/whatsapp", auth_1.default, analyticsController_1.getWhatsAppAnalytics);
router.get("/:eventId/analytics/sms", auth_1.default, analyticsController_1.getSmsAnalytics);
